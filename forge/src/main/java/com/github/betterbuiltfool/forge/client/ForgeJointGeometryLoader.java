...
public class ForgeJointGeometryLoader implements IGeometryLoader<ForgeJointGeometryLoader.Unbaked> {
    public static final ForgeJointGeometryLoader INSTANCE = new ForgeJointGeometryLoader();
    
    private ForgeJointGeometryLoader() {}
    ...
    public record Unbaked() implements IUnbakedGeometry<ForgeJointGeometryLoader.Unbaked> {
